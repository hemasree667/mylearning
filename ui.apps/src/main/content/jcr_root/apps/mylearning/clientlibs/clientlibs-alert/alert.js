...
//To Load LocalInfo Manually
var metaElement = document.createElement('meta');
metaElement.setAttribute('property', 'og:locale');
metaElement.setAttribute('content', 'en_us');
document.head.appendChild(metaElement);

// Execute code after both scripts are loaded
var scriptsLoaded = 0;
...
cf.globalHeader = (function () {
	...
	function getAlertData(localeCountry, localeLanguage) {
		var alertJsonPath = '/ibm-pb-asset/alert.' + localeCountry + "." + localeLanguage + ".json";
